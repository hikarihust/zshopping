...
class Zendvn_Sp_AdminProduct_Controller{
	...
	public function __construct(){
		...
		add_filter( 'post_updated_messages', array($this,'zsproduct_updated_messages'));
		add_filter( 'bulk_post_updated_messages', array($this,'filter_bulk_zsproduct_updated_messages'), 10, 2  ); 
	}
